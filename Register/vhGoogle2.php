...
<?
    ...
    $clientID = '987610195187-po8lonml3a6jlupv3m4dasi6f5l2si75.apps.googleusercontent.com';
    $clientSecret = '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';
    $redirectUri = 'http://localhost/diplom/Register/vhGoogle.php';
            ...
            <form action="">
                ...
                <?
                    if(isset($_GET['code'])){
                        ...
                        $emailg =  $google_account_info->email;
                        echo    "<a href='delete.php'>delete</a>";
                        $_SESSION['user']['email'] = $emailg;
                        header('Location: ../index.php');
                    }
                    else{
